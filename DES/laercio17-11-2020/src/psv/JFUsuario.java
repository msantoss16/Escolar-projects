...
public class JFUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblPrivilegio.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        ...
        txtPrivilegio.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
                ...
                .addGroup(pnlCentralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlCentralLayout.createSequentialGroup()
                        .addGroup(pnlCentralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblPrivilegio, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(18, 18, 18)
                        .addGroup(pnlCentralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtUsername, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtPrivilegio, javax.swing.GroupLayout.PREFERRED_SIZE, 409, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnIncluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnIncluirMouseClicked
        ...
        ub.setUsuario(txtUsername.getText());
        ub.setSenha(txtSenha.getText());
        ub.setPrivilegio(Integer.parseInt(txtPrivilegio.getText()));
    ...
    private void btnPesquisarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisarMouseClicked
        ...
        for (UsuarioBean ub : listaUsuario) {
            ...
            tbConsulta.setValueAt(ub.getUsuario(), i, 0);
            tbConsulta.setValueAt("", i, 1);
            tbConsulta.setValueAt(ub.getPrivilegio(), i, 2);
    ...
    private void tbConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbConsultaMouseClicked
        ...
        String linha = ""+tbConsulta.getSelectedRow();
        String usuario = (String) tbConsulta.getValueAt(Integer.parseInt(linha), 0);
        String senha = (String) tbConsulta.getValueAt(Integer.parseInt(linha), 1);
        String privilegio = ""+(Integer) tbConsulta.getValueAt(Integer.parseInt(linha), 2);
        txtUsername.setText(usuario);
        txtSenha.setText(senha);
        txtPrivilegio.setText(privilegio);
    ...
    private void btnAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAlterarMouseClicked
        ...
        String usuario = (String) tbConsulta.getValueAt(linha, 0);
        UsuarioBean ub = new UsuarioBean("", "", 0);
        UsuarioDAO ud = new UsuarioDAO(con);
        ub.setUsuario(txtUsername.getText()+"|"+usuario);
        ub.setSenha(txtSenha.getText());
        ub.setPrivilegio(Integer.parseInt(txtPrivilegio.getText()));
    ...
    private void btnExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExcluirMouseClicked
        ...
        int i = JOptionPane.showOptionDialog(
                null,
                "Deseja excluir esse veículo: " + txtUsername.getText() + "?",
                "Exclusão",
